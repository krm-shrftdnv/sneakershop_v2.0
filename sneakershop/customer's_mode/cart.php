...
if (isset($_SESSION['order'])) { ?>
    ...
    foreach ($_SESSION['cart'] as $product) {
        ?>
            <div class="card">
                <a href="product.php?id=<?php echo $product['id'] ?>"><img src="img/<?php echo $product['img'] ?>" style="max-height: 300px" class="card-img-top"
  ...
  <path fill-rule="evenodd"
        ...
        clip-rule="evenodd"/>
                ...
                <input type="text" name="username" class="form-control" placeholder="Иван" aria-label="somebody"
  ...
  <path fill-rule="evenodd"
    ...
    ?>
    <div class="container-sm p-4 " style="max-width: 40em; margin-top: 50px"><h2>В вашей корзине ещё нет покупок</h2></div>
<!--    <a href="index.php">На главную</a>-->
    <?php
}
?>
